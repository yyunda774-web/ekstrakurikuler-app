...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            ...
            <h1 class="h2 mb-0"><i class="fas fa-plus-circle text-primary me-2"></i>Tambah Ekstrakurikuler</h1>
        </div>
        <a href="{{ route('admin.ekstrakurikuler.index') }}" class="btn btn-light btn-icon-split">
    ...
    <div class="card shadow-lg border-0 rounded-xl overflow-hidden">
        ...
        <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="h4 mb-0 text-dark">Form Tambah Ekstrakurikuler Baru</h3>
                    <p class="text-muted mb-0">Lengkapi form berikut untuk menambahkan ekstrakurikuler baru</p>
                </div>
                <div class="col-auto">
                    <span class="badge bg-soft-primary text-primary px-3 py-2">
                        <i class="fas fa-pencil-alt me-1"></i> Form Input
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-5">
            <form action="{{ route('admin.ekstrakurikuler.store') }}" method="POST" id="ekskulForm">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group position-relative">
                            ...
                            <div class="form-text d-flex align-items-center mt-2">
                                <i class="fas fa-info-circle text-primary me-2 fs-sm"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <textarea name="deskripsi" class="form-control form-control-lg" 
                                      rows="4" placeholder="Masukkan deskripsi ekstrakurikuler..."></textarea>
                            <div class="form-text d-flex align-items-center mt-2">
                                <i class="fas fa-lightbulb text-warning me-2 fs-sm"></i>
                ...
                <div class="position-relative my-5">
                    ...
                    <div class="divider-text bg-white px-3 position-absolute top-50 start-50 translate-middle">
                        <i class="fas fa-check-circle text-primary me-2"></i>Konfirmasi Data
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center pt-4">
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <i class="fas fa-exclamation-circle text-muted fs-4"></i>
                        </div>
                        <div>
                            <p class="mb-0 text-muted fw-medium">Pastikan data yang dimasukkan sudah benar</p>
                            <small class="text-muted">Periksa kembali sebelum menyimpan</small>
                        </div>
                    </div>
                    
                    <div class="d-flex gap-3">
                        <button type="reset" class="btn btn-lg btn-outline-secondary px-4 rounded-pill">
        ...
        <div class="card-footer bg-soft-light border-top-0 py-4">
            <div class="alert alert-soft-info border-0 mb-0 d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                    ...
                    <p class="mb-0">Ekstrakurikuler yang telah ditambahkan akan langsung aktif untuk pendaftaran siswa. Pastikan semua informasi sudah lengkap dan akurat.</p>
                </div>
            </div>
        </div>
    </div>
...
<style>
    ...
    .card:hover {
        box-shadow: 0 0.5rem 1.5rem rgba(58, 59, 69, 0.15) !important;
    }
    ...
    .btn-primary:hover {
        background: linear-gradient(135deg, #224abe, var(--primary));
